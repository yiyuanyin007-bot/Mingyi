...
time.sleep(0.5)
send("evaluate", {"code": "goToLearn('gui-zhi-jia-ge-gen-tang')"})
time.sleep(0.3)
send("evaluate", {"code": "startExam('gui-zhi-jia-ge-gen-tang')"})
time.sleep(0.3)
ss = send("screenshot", {"path": "C:/Users/Chen/Desktop/经方学习系统（旧版）/app/screenshot_exam.png"})
